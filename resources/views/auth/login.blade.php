<main class="container m-auto py-4 lg:py-6 xl:py-8 2xl:py-10">
    <div>
        ...
        <div class="grid place-content-center gap-[25px]">
            ...
            <button
                class="w-[346px] h-10 bg-blue-800 text-white hover:bg-white focus:bg-white hover:text-blue-800 focus:text-blue-800 rounded-[5px] border border-blue-800 border-opacity-50 focus:outline-none  transition-colors duration-300"
                wire:click="login"
            >
                LOGIN
            </button>
        </div>
        <div class="grid place-content-center grid-flow-col mt-5 gap-x-28 mb-[171px]">
            <a href="/sign-up" class="text-zinc-800 text-sm font-semibold font-['Open Sans']">Sign up</a>
            <div class="text-zinc-800 text-sm font-semibold font-['Open Sans']">Forgot Password?</div>
        </div>
    </div>
</main>
