    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div>
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-800">
                <li>
                    <a href="{{ route('home') }}" class="block py-2 px-3 text-white bg-blue-800 rounded hover:bg-white hover:text-blue-800 focus:bg-white focus:text-blue-800 focus:outline-none">
                        {{-- {{ Auth::user()->username }} --}}
